  ...
  return (
    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="lg:pr-4">
            ...
            <h1 className="mt-8 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Chemosynthesis</h1>
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
            ...
            <p className="mt-8"></p>
            <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">why is chemosynthesis important</h2>
            <p className="mt-6"> Chemosynthetic bacteria form the base of food webs in these ecosystems, supporting diverse life forms, including giant tube worms and various other organisms that depend on them for energy.</p>
            </div>
        </div>
        </div>
    </div>
